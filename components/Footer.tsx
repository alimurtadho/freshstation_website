...
export default function Footer() {
  ...
  const footerLinks = {
    company: [
      ...
      { name: 'Our Farm', href: '#gallery' },
      { name: 'Quality Standards', href: '#services' },
      { name: 'Sustainability', href: '#about' }
    ],
    products: [
      { name: 'Premium Hass', href: '#products' },
      { name: 'Bulk Orders', href: '#products' },
      { name: 'Organic Avocado', href: '#products' },
      { name: 'Custom Packaging', href: '#services' }
    ],
    services: [
      { name: 'B2B Wholesale', href: '#services' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <img 
              ...
              onError={(e) => {
                e.currentTarget.src = "/img/logo-white.svg";
              }}
            />
          </div>
              <p className="text-gray-300 mb-4">
                Premium Avocado Hass supplier from Indonesia. We provide fresh, 
                quality guaranteed avocados direct from our farm to your table.
              </p>
              <div className="flex space-x-4">
                ...
                <a
                  href="https://wa.me/6285174416682"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-gray-800 rounded-lg hover:bg-primary-600 transition-colors"
                >
                ...
                <a
                  href="mailto:freshstation45@gmail.com"
                  className="p-2 bg-gray-800 rounded-lg hover:bg-primary-600 transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Fresh Station Indonesia. All rights reserved.
            </div>
